...
const icons = {
  ...
  "/interviews": () => <Icons.Interviews size={20} />,
  "/candidates": () => <Icons.Candidates size={20} />,
  "/positions": () => <Icons.Positions size={20} />,
  "/scenarios": () => <Icons.Code size={20} />,
...
const items = [
  ...
  },
  {
    ...
    name: "Positions",
    children: [
      { path: "/positions?statuses=paid", name: "Paid" },
      { path: "/positions?statuses=unpaid", name: "Unpaid" },
      { path: "/positions?statuses=overdue", name: "Overdue" },
      { path: "/positions?statuses=draft", name: "Draft" },
      { path: "/positions?statuses=scheduled", name: "Scheduled" },
      { path: "/positions?type=create", name: "Create new" },
    ],
  },
  {
    path: "/candidates",
    ...
    children: [
      {
        path: "/candidates?step=connect",
        name: "Connect bank",
      },
      {
        path: "/candidates?step=import&hide=true",
        name: "Import",
      },
      { path: "/candidates?createTransaction=true", name: "Create new" },
    ],
  },
  {
    path: "/scenarios",
    name: "Scenarios",
    children: [
      { path: "/scenarios", name: "All" },
      { path: "/scenarios?tab=installed", name: "Installed" },
    ],
  },
  {
    path: "/apps",
...
const ChildItem = ({
  ...
  return (
    <Link prefetch href={child.path} onClick={() => onSelect?.()} className="block group/child">
        ...
        <div className="relative">
          ...
          <div
            className={cn(
              ...
              isActive && "bg-[#F2F1EF] dark:bg-secondary border-[#DCDAD2] dark:border-[#2C2C2C]",
